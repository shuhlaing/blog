                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-7 log-det">
                            <div class="small-logo">
                                <i class="fab fa-asymmetrik"></i> Exit Login
                            </div>
                            <h2>Sign in to Exit Blog</h2>
                            <div class="row">
                                <ul>
                                    <li><i class="fab fa-asymmetrik"></i></li>
                                    <li><i class="fab fa-asymmetrik"></i></li>
                                    <li><i class="fab fa-asymmetrik"></i></li>
                                </ul>
                            </div>
                            <div class="row">
                                <p class="small-info">Use your email and password</p>
                            </div>


                            <div class="text-box-cont">
                                <div class="input-group mb-3" style="padding-bottom:10px !important;">
                                ...
                                <div class="input-group center mb-3" style="padding-top:10px !important;">
                        ...
                        <div class="col-lg-4 col-md-5 box-de">
                            <div class="ditk-inf">
                                ...
                                <p>Simply Create your account by clicking the Re Button</p>
                                <a href="register.php">
