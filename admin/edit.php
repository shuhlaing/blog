...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-left:100px;">
                <h6 class="section-title bg-white text-center text-primary px-3">Form</h6>
                <h3 class="mb-5">Post Edit Form</h3>
            </div>
              ...
              <div class="col-md-8">
                <div class="table-container">
                  ...
                  <div class="form-group row" style="padding-bottom:20px;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Title</strong></label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputEmail3">
                    </div>
                  </div>
                  <div class="form-group row" style="padding-bottom:20px;">
                    <label for="inputPassword3" class="col-sm-2 col-form-label"><strong>Content</strong></label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" cols="70"></textarea>
                    </div>
                  </div>
                  <div class="form-group row" style="padding-bottom:20px;">
                    <label for="inputPassword3" class="col-sm-2 col-form-label"><strong>Image</strong></label>
                    <div class="col-sm-10">
                      <input type="file" class="form-control-file" id="exampleFormControlFile1">
                    </div>
                  </div>
                  <div class="form-group row" style="padding-bottom:20px;">
                    <div class="col-sm-10" style="margin-left:130px;border:10px;">
                      <button type="submit" class="btn btn-primary" style="text-align:center;">Upload</button>
