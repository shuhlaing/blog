    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="text-left wow fadeInUp" data-wow-delay="0.1s">
                <a href="user_add.php" type="button" class="btn btn-info" style="background-color:#06BBCC;color:white;border-radius:5px;padding:10px;float:left;">Create New User</a>
            </div>
